                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="name" id="form_name" class="form-control" placeholder="First Name *" value="" />
                                        </div>
                                        <span class="error_form" id="name_error_message"></span>
                                        <div class="form-group">
                                            <input type="text" name="first_surname" id="form_surname" class="form-control" placeholder="First surname *" value="" />
                                        </div>
                                        <span class="error_form" id="surname_error_message"></span>
                                        <div class="form-group">
                                            <input type="text" name="second_surname" id="form_surname2" class="form-control" placeholder="Second surname *" value=""/>
                                        </div>
                                        <span class="error_form" id="surname2_error_message"></span>
                                        <div class="form-group">
                                            <input type="text" name="username"  id="form_username" class="form-control"  placeholder="Username *" value=""/>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email" id="form_email" class="form-control" placeholder="Your Email *" value="" />
                                        </div>
                                        <span class="error_form" id="email_error_message"></span>
                                        <div class="form-group">
                                            <input type="number" name="phone_number" id="form_phone"  class="form-control" placeholder="Your Phone *" value=""/>
                                        </div>
                                        <span class="error_form" id="phone_error_message"></span>
                                        <div class="form-group">
                                            <input type="number" name="age" id="form_age" class="form-control"  placeholder="Age *" value=""/>
                                        </div>
                                        <span class="error_form" id="age_error_message"></span>

                                        <div class="form-group">
                                            <select class="form-control">
                                                <option class="hidden" selected disabled>Select your rate</option>
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="address" id="form_address"  class="form-control" placeholder="Address *" value=""/>
                                        </div>
