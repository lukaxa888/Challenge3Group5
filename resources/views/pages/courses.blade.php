  ...
  <div class="col-md-6 mb-5 ">
    <div class="bg-white p-5 rounded-lg shadow">
      ...
      <ul class="list-unstyled my-5 text-small text-left">
        ...
        <img  src="{{asset('img/bike.jpg')}}" id="bikeImage" width="500" height="400">
  ...
  <div class="col-md-6 mb-5 ">
    <div class="bg-white p-5 rounded-lg shadow">
      ...
      <ul class="list-unstyled my-5 text-small text-left">
        ...
        <img src="{{asset('img/zumba.jpg')}}" id="imagenZumba">
  ...
  <div class="col-md-6 mb-5 ">
    <div class="bg-white p-5 rounded-lg shadow">
      ...
      <ul class="list-unstyled my-5 text-small text-left">
        ...
        <img src="{{asset('img/crossfit.jpg')}}" id="crossFitImage">
  ...
  <div class="col-md-6 mb-5 ">
    <div class="bg-white p-5 rounded-lg shadow">
      ...
      <ul class="list-unstyled my-5 text-small text-left">
        ...
        <img  src="{{asset('img/aquagym.jpg')}}" id="aquaGymImage">
